...
function main() {
  ...
  // absolute path
  image.src = "/projects/film-grain-filter/static/images/1.jpg";
  image.onerror = () => {
  ...
  const image_1_btn = document.getElementById("image_1");
  const image_2_btn = document.getElementById("image_2");

  image_1_btn.addEventListener("click", () => {
    image.src = "/projects/film-grain-filter/static/images/1.jpg";
    render(image);
  });

  image_2_btn.addEventListener("click", () => {
    image.src = "/projects/film-grain-filter/static/images/2.jpg";
    render(image);
  });
}
